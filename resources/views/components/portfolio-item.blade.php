...
>
    <div class="relative mb-12">
        ...
        <div class="text-center bg-white dark:bg-slate-800 relative z-10 py-9 px-3 rounded-lg shadow-lg mx-7 -mt-4 h-[200px]">
            <span class="text-primary font-semibold block mb-2">
                {{ implode(", ", $categories) }}
            </span>
