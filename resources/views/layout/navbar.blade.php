    ...
    <div class="container">
        <div class="flex -mx-4 items-center justify-between relative">
            <div class="pr-4 w-full max-w-full">
                ...
                <span class="text-xl xl:text-2xl font-bold text-[#0c7187] dark:text-white">TheWebtech</span>
                </a>
            </div>

            <div class="flex px-4 justify-end items-center w-full">
                <x-layout.navbar-hambugger 
                ...
                <ul class="block lg:flex lg:items-center">
                    ...
                    {{-- <div class="g-ytsubscibe" data-channelid="UC_UMECP" data-lang="default" data-count="default">
